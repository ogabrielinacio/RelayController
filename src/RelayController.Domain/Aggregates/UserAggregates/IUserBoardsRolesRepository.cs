...
{
    Task<UserBoardsRoles?> GetByUserIdAndBoardId(Guid userId, Guid boardId, CancellationToken cancellationToken);
    ...
    Task<List<UserBoardsRoles>> GetByBoardId(Guid userId, CancellationToken cancellationToken);
    Task RemoveAsync(UserBoardsRoles role, CancellationToken cancellationToken);
    Task UpdateAsync(UserBoardsRoles role, CancellationToken cancellationToken);
