...
namespace RelayController.Infrastructure.Migrations
{
    ...
    [Migration("20251207175237_AddPowerStateChangedAt")]
    partial class AddPowerStateChangedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RelayController.Domain.Aggregates.RelayControllerAggregates.RelayControllerBoard", b =>
                {
                    ...
                    b.Property<DateTime?>("PowerStateChangedAt")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("RelayController.Domain.Aggregates.RelayControllerAggregates.Routine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("relay_controller_routines", (string)null);
                });
                    ...
                    b.OwnsOne("RelayController.Domain.ValueObjects.Time", "EndTime", b1 =>
                        {
                            ...
                            b1.ToTable("relay_controller_routines");
